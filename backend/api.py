...
class AnsariTTSBaseClass(object):
    def __init__(self, 
                config_path, 
                device='cuda:0'):
        if 'cuda' in device:
...
class BaseSpeakerTTS(AnsariTTSBaseClass):
    language_marks = {
        "english": "EN",
        "chinese": "ZH",
    }
...
class ToneColorConverter(AnsariTTSBaseClass):
    ...
    def convert(self, audio_src_path, src_se, tgt_se, output_path=None, tau=0.3, message="ByAnsariTTS"):
        hps = self.hps
        # load audio
